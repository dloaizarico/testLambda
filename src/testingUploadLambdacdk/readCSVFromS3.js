...
function readCsvFromS3(bucketName, key) {
    return __awaiter(this, void 0, void 0, function () {
        var s3Object, csvData, rl, headers, headerRowIndex, rowIndex, _loop_1, _a, rl_1, rl_1_1, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, clients_1.s3.getObject({
                        Bucket: bucketName,
                        Key: key,
                    })];
                case 1:
                    ...
                    csvData = [];
                    rl = (0, readline_1.createInterface)({ input: s3Object.Body, crlfDelay: Infinity });
                    headers = [];
                    headerRowIndex = -1;
                    rowIndex = 0;
                    _e.label = 2;
                case 2:
                    ...
                    _loop_1 = function () {
                        ...
                        var line = _d;
                        var row = line.split(",");
                        if (headerRowIndex === -1 && row.some(function (cell) { return isNaN(Number(cell.trim())); })) {
                            headers = row;
                            ...
                            headers.forEach(function (header, colIndex) {
                                ...
                                dataRow_1[header.trim()] = value ? value : undefined;
                            });
                            csvData.push(types_1.TestResultRowSchema.parse(dataRow_1));
                        }
                        rowIndex++;
                    };
