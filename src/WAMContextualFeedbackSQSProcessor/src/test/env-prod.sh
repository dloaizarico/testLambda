...
export API_BPEDSYSGQL_GRAPHQLAPIIDOUTPUT=qmelml425ndobo5xlomfqfhkyi
# The endpoint of the GraphQL API; this would normally be provided by the lambda environment via cloudformation
export API_BPEDSYSGQL_GRAPHQLAPIENDPOINTOUTPUT=https://drqrwrxsovhvdi3sz3d6nz7nwy.appsync-api.ap-southeast-2.amazonaws.com/graphql
# The API key to use for OpenAI - this is just Mikes temp key for testing skipcq: SCT-1013
export OPEN_AI_API_KEY=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
# Base URL for OpenAI
...
export LAMBDA_FACULTY_COGNITO_USER_PASSWORD=/amplify/d31ul62nbvaagu/prod/AMPLIFY_WAMContextualFeedbackSQSProcessor_LAMBDA_FACULTY_COGNITO_USER_PASSWORD
# These will be provided to the lambda by cloudformation
export AUTH_BPEDSYSAUTH_USERPOOLID=ap-southeast-2_1whXi1H8I
export AUTH_BPEDSYSAUTH_APPCLIENTIDWEB=2rmd35ucpgqfcvheipffqerl3f
...
export DEV_OVERRIDE_EMT_API_URL=https://prod-aus.elastik-emt.com/
...
export DEV_APPSYNC_COGNITO_USER=diego.loaiza@elastik.com
export DEV_APPSYNC_COGNITO_PASS=Password24!
